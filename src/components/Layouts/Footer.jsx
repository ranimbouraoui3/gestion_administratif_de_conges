...
export const Footer = () => {
    return (
        <footer className="fixed bottom-0 left-0 w-full bg-white shadow dark:bg-gray-800 z-50">
            <div className="p-4 mx-auto max-w-screen-xl md:flex md:items-center md:justify-between md:p-6">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
                    © 2025 <Link to="/" className="hover:underline">Adminity Master</Link>. All Rights Reserved.
                </span>
